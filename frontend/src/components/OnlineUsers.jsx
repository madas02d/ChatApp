                  ...
                  {relationship === 'friend' ? (
                    <div className="flex gap-2">
                      <button
                        ...
                        className="px-3 sm:px-4 py-2 bg-green-500 text-white text-xs sm:text-sm rounded-lg hover:bg-green-600 transition-colors flex items-center space-x-1 sm:space-x-2"
                        title="Start chat"
                      >
                      ...
                      <button
                        onClick={() => startCall(onlineUser._id, 'video')}
                      ...
                      <button
                        onClick={() => startCall(onlineUser._id, 'audio')}
                        className="px-3 sm:px-4 py-2 bg-purple-500 text-white text-xs sm:text-sm rounded-lg hover:bg-purple-600 transition-colors"
                        title="Audio call"
                      >
                        📞
                      </button>
